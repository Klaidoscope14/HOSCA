          ...
          <CardContainer className="w-full">
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-8 border">
              ...
              <div className="grid grid-cols-2 gap-4">
                <img src="/club/quiz.jpg" alt="quiz Debate" className="rounded-lg w-full h-48 object-cover" />
                <img src="/club/quiz.jpg" alt="quiz MUN" className="rounded-lg w-full h-48 object-cover" />
                <img src="/club/quiz.jpg" alt="quiz Event" className="rounded-lg w-full h-48 object-cover" />
                <img src="/club/quiz.jpg" alt="quiz Team" className="rounded-lg w-full h-48 object-cover" />
              </div>
            </CardBody>
          </CardContainer>
        </div>
