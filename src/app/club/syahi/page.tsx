...
=======
              <div className="grid grid-cols-2 gap-4">
                <img src="/ClubLogo/syahi.jpg" alt="quiz Debate" className="rounded-lg w-full h-48 object-cover" />
                <img src="/ClubLogo/syahi.jpg" alt="quiz MUN" className="rounded-lg w-full h-48 object-cover" />
                <img src="/ClubLogo/syahi.jpg" alt="quiz Event" className="rounded-lg w-full h-48 object-cover" />
                <img src="/ClubLogo/syahi.jpg" alt="quiz Team" className="rounded-lg w-full h-48 object-cover" />
>>>>>>> upstream/main
              </div>
            </CardBody>
          </CardContainer>
