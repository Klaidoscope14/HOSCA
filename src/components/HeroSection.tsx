  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className=" min-h-screen w-full flex flex-col items-center justify-center text-white px-4 space-y-1">
           ...
           <VideoText
            className="w-full h-[160px] rounded-lg sm:h-[200px] md:h-[250px] lg:h-[280px] font-bold bg-gradient-to-r from-white via-white to-white bg-clip-text text-transparent animate-gradient-x "
